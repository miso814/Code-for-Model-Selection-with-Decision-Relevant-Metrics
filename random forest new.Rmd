...
hist(price_coef, 
     ...
     col = "skyblue", 
     main = "",
     xlab = "Price Coefficient (β_price)",
     ylab = "Frequency")
...
**fitting global random forest on training dataset**
```{r}
...
**frequncy table of two prices under the rf pricing policy on training dataset**
```{r}
...
**Calculation of the expected total revenue based on the rf pricing policy and the ground truth individual preferences**
```{r}
...
**Fitting the trained random forest on testing data, find the pricing policy and the expected total revenue  **
```{r}
...
**frequncy table of two prices under the rf pricing policy on testing dataset**
```{r}
